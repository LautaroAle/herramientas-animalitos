...
export const TOOLS: ToolDefinition[] = [
  ...
  { slug: "investigacion", name: "Panel de investigación", shortDescription: "Buscá opiniones reales en Reddit sobre lo que querés comprar o decidir, con temas repetidos detectados automáticamente.", category: "investigacion", keywords: ["comparar productos", "opiniones", "reviews", "que aspiradora robot comprar", "vale la pena"], implemented: true, href: "/herramientas/investigacion", icon: "Search" }
];
